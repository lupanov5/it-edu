...
window.addEventListener('DOMContentLoaded', function () {
  ...
  forms.init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.showup .play', '.overlay').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video-item .play', '.overlay').init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(block, items, counter) {
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slider/slider.js");
...
function (_Slider) {
  ...
  return MiniSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_10__["default"]);
